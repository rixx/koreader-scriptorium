...
package.preload["lua-ljsqlite3/init"] = function()
    return { open = function() error("stats DB must not be opened in this test") end }
end
...
package.preload["rapidjson"] = function()
    return { array = function(t) rawset(t, "__is_array", true) return t end }
end
...
local annotations = {
    { datetime = "2026-06-01 10:00:00", drawer = "lighten", color = "yellow",
      text = "first highlight", chapter = "Ch 1", pageno = 12, pos0 = "xp0", pos1 = "xp1" },
    { datetime = "2026-06-02 11:00:00" }, -- plain page bookmark, no drawer
    { datetime = "2026-06-03 12:00:00", datetime_updated = "2026-06-05 09:00:00",
      drawer = "underscore", text = "second", note = "a note", pageno = 40 },
}
local ds = DS{
...
check(fp == "2:2026-06-05 09:00:00", "fingerprint counts highlights, uses latest datetime_updated, got: " .. tostring(fp))
